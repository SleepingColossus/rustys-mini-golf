...
impl Game {
    pub fn new() -> Self {
        ...
        let tiles: Vec<Vec<i32>> = vec![
            ...
            vec![43,7,8,8,8,8,22,20,20,20,20,20,20,20,20,25,45],
            vec![43,7,8,8,8,8,8,8,8,8,8,8,8,8,8,9,45],
            ...
            vec![43,27,20,20,20,20,20,20,20,20,23,8,8,8,8,9,45],
            vec![43,7,8,8,8,8,8,8,8,8,8,8,8,8,8,9,45],
            vec![43,7,8,8,8,8,8,8,8,8,8,8,8,8,8,9,45],
            vec![43,7,8,8,8,8,8,8,8,8,8,8,8,8,8,9,45],
            vec![43,13,14,14,14,14,14,14,14,14,14,14,14,14,14,15,45],
            vec![49,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,51],
        ];
